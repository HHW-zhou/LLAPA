...
Pre-trained weights are provided at [stage1 weight](https://pan.baidu.com/s/1ml6R48SFyyGoYQXTH8DR0Q?pwd=vqhi). If you wish to perform pre-training, execute the following command:
